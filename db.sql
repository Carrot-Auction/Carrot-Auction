...
-- Schema carrotaction
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `carrotaction` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `carrotaction`.`alarm` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `carrotaction`.`category` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `carrotaction`.`favorite_item` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `carrotaction`.`item` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `carrotaction`.`item_bider` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `carrotaction`.`item_image` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `carrotaction`.`user` ;
